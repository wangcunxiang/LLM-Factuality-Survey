...
1.   WikiChat: Stopping the Hallucination of Large Language Model Chatbots by Few-Shot Grounding on Wikipedia. _Semnani et al._ EMNLP 2023 findings. [[Paper](https://aclanthology.org/2023.findings-emnlp.157/)] [[GitHub]](https://github.com/stanford-oval/WikiChat) [[Demo]](https://wikichat.genie.stanford.edu/)
...
| AGIEval [Zhong et al, 2023](https://arxiv.org/abs/2304.06364) | Multi-Choice QA | Gaokao, (geometry, Bio,<br/>history...),SAT, Law... | ACC | (zero-shot, average ACC)<br/>GPT-4: 56.4<br/>GPT-3.5: 42.9<br/>LLaMA2-70B: 40.02 |
